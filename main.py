...
#this is used in order to connect to the database of our project and populate the database
config = {	
...
db = firebase.database()  #we tell firebase we want to use the database, nothing else
